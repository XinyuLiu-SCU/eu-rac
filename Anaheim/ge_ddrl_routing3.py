"""
ge_ddrl_routing3.py - Anaheim-adapted GE-DDRL.

This is an Anaheim-adapted GE-DDRL implementation.
...
This is the Anaheim-adapted GE-DDRL baseline, not a strict faithful DRL_C51 reference. The original reference migration remains in ge_ddrl_reference.py for audit only. This implementation preserves the core tabular distributional Bellman updates while adapting the routing interface, feasibility filtering, and path extraction to the Anaheim benchmark.
"""
...
def run_ge_ddrl_routing(env, budget: int,
    ...
    return {
        ...
        "path_len": len(path),
        "training_protocol": "Anaheim-adapted v3: 1000 Dijkstra-guided + 5000 on-policy",
