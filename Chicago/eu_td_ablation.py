...
def run_eu_td_ablation(
    ...
    agent = EUTDAblation(
        ...
        entropy_coef=cs.EURAC_ENTROPY_COEF,
        kl_coef=cs.EURAC_KL_COEF,
        device=device,
    )
...
def parse_args():
    parser = argparse.ArgumentParser(description="Chicago EU-TD ablation smoke/formal runner.")
