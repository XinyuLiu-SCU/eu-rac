"""
ge_ddrl_routing3.py - Beijing-compatible GE-DDRL runner integration.

This is the Beijing-compatible GE-DDRL implementation used by the official runner.
...
This implementation preserves the core tabular distributional Bellman updates while adapting the routing interface, feasibility filtering, and path extraction to the Beijing benchmark.
"""
...
def run_ge_ddrl_routing(env, budget: int,
    ...
    return {
        ...
        "path_len": len(path),
        "training_protocol": "Beijing-compatible v3: Dijkstra-guided plus on-policy training",
