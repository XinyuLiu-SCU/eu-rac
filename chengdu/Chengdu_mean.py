...
NETWORK_DIR = ROOT / "Chengdu_network"
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--uncertainty-file", type=Path, default=None, help="Period uncertainty JSON file or directory; default uses Chengdu_network/uncertainty")
