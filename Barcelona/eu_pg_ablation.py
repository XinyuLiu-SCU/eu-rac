"""
EU-PG ablation for Barcelona.

Keeps the neural actor pieces from EU-RAC3:
  - GCN encoder
  - action scorer
  - masked policy distribution
  - execution uncertainty through BarcelonaEnv
...
class EUPGAblation:
    ...
    def warm_start_dijkstra(self, epochs=80, budget_slack=50):
...
def parse_args():
    parser = argparse.ArgumentParser(description="Barcelona EU-PG ablation smoke/formal runner.")
